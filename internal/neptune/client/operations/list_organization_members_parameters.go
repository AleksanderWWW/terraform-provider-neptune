...
// WithOrganizationIdentifier adds the organizationIdentifier to the list organization members params
func (o *ListOrganizationMembersParams) WithOrganizationIdentifier(organizationIdentifier string) *ListOrganizationMembersParams {
	o.SetOrganizationIdentifier(organizationIdentifier)
	return o
}

// SetOrganizationIdentifier adds the organizationIdentifier to the list organization members params
func (o *ListOrganizationMembersParams) SetOrganizationIdentifier(organizationIdentifier string) {
