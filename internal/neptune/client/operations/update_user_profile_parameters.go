...
type UpdateUserProfileParams struct {
	...
	// UserProfileUpdate.
	UserProfileUpdate *models.UserProfileUpdateDTO
...
// WithUserProfileUpdate adds the userProfileUpdate to the update user profile params
func (o *UpdateUserProfileParams) WithUserProfileUpdate(userProfileUpdate *models.UserProfileUpdateDTO) *UpdateUserProfileParams {
	o.SetUserProfileUpdate(userProfileUpdate)
	return o
}

// SetUserProfileUpdate adds the userProfileUpdate to the update user profile params
func (o *UpdateUserProfileParams) SetUserProfileUpdate(userProfileUpdate *models.UserProfileUpdateDTO) {
	o.UserProfileUpdate = userProfileUpdate
}
...
func (o *UpdateUserProfileParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.UserProfileUpdate != nil {
		if err := r.SetBodyParam(o.UserProfileUpdate); err != nil {
			return err
		}
	}
