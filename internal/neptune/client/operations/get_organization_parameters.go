...
// WithOrganization adds the organization to the get organization params
func (o *GetOrganizationParams) WithOrganization(organization string) *GetOrganizationParams {
	o.SetOrganization(organization)
	return o
}

// SetOrganization adds the organization to the get organization params
func (o *GetOrganizationParams) SetOrganization(organization string) {
