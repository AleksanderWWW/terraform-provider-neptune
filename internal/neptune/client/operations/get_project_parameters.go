...
// WithProjectIdentifier adds the projectIdentifier to the get project params
func (o *GetProjectParams) WithProjectIdentifier(projectIdentifier string) *GetProjectParams {
	o.SetProjectIdentifier(projectIdentifier)
	return o
}

// SetProjectIdentifier adds the projectIdentifier to the get project params
func (o *GetProjectParams) SetProjectIdentifier(projectIdentifier string) {
