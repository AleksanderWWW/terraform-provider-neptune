...
type CreateServiceAccountParams struct {
	...
	// AddToAllProjects.
	AddToAllProjects bool

	// NewServiceAccount.
	NewServiceAccount *models.NewServiceAccountDTO
...
// WithAddToAllProjects adds the addToAllProjects to the create service account params
func (o *CreateServiceAccountParams) WithAddToAllProjects(addToAllProjects bool) *CreateServiceAccountParams {
	o.SetAddToAllProjects(addToAllProjects)
	return o
}

// SetAddToAllProjects adds the addToAllProjects to the create service account params
func (o *CreateServiceAccountParams) SetAddToAllProjects(addToAllProjects bool) {
	o.AddToAllProjects = addToAllProjects
}

// WithNewServiceAccount adds the newServiceAccount to the create service account params
func (o *CreateServiceAccountParams) WithNewServiceAccount(newServiceAccount *models.NewServiceAccountDTO) *CreateServiceAccountParams {
	o.SetNewServiceAccount(newServiceAccount)
	return o
}

// SetNewServiceAccount adds the newServiceAccount to the create service account params
func (o *CreateServiceAccountParams) SetNewServiceAccount(newServiceAccount *models.NewServiceAccountDTO) {
	o.NewServiceAccount = newServiceAccount
}

// WithOrganizationIdentifier adds the organizationIdentifier to the create service account params
func (o *CreateServiceAccountParams) WithOrganizationIdentifier(organizationIdentifier string) *CreateServiceAccountParams {
	o.SetOrganizationIdentifier(organizationIdentifier)
	return o
}

// SetOrganizationIdentifier adds the organizationIdentifier to the create service account params
func (o *CreateServiceAccountParams) SetOrganizationIdentifier(organizationIdentifier string) {
...
func (o *CreateServiceAccountParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// query param addToAllProjects
	qrAddToAllProjects := o.AddToAllProjects
	qAddToAllProjects := swag.FormatBool(qrAddToAllProjects)
	if qAddToAllProjects != "" {

		if err := r.SetQueryParam("addToAllProjects", qAddToAllProjects); err != nil {
			return err
		}
	}
	if o.NewServiceAccount != nil {
		if err := r.SetBodyParam(o.NewServiceAccount); err != nil {
			return err
		}
	}
