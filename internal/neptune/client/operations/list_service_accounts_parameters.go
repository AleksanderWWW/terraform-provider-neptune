...
// WithDeactivated adds the deactivated to the list service accounts params
func (o *ListServiceAccountsParams) WithDeactivated(deactivated *bool) *ListServiceAccountsParams {
	o.SetDeactivated(deactivated)
	return o
}

// SetDeactivated adds the deactivated to the list service accounts params
func (o *ListServiceAccountsParams) SetDeactivated(deactivated *bool) {
	o.Deactivated = deactivated
}

// WithOrganizationIdentifier adds the organizationIdentifier to the list service accounts params
func (o *ListServiceAccountsParams) WithOrganizationIdentifier(organizationIdentifier string) *ListServiceAccountsParams {
	o.SetOrganizationIdentifier(organizationIdentifier)
	return o
}

// SetOrganizationIdentifier adds the organizationIdentifier to the list service accounts params
func (o *ListServiceAccountsParams) SetOrganizationIdentifier(organizationIdentifier string) {
...
func (o *ListServiceAccountsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Deactivated != nil {
		...
		var qrDeactivated bool

		if o.Deactivated != nil {
			qrDeactivated = *o.Deactivated
		}
		qDeactivated := swag.FormatBool(qrDeactivated)
		if qDeactivated != "" {
