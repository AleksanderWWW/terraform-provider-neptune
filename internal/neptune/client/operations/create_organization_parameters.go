...
type CreateOrganizationParams struct {
	...
	OrganizationToCreate *models.OrganizationCreationParamsDTO
...
// WithOrganizationToCreate adds the organizationToCreate to the create organization params
func (o *CreateOrganizationParams) WithOrganizationToCreate(organizationToCreate *models.OrganizationCreationParamsDTO) *CreateOrganizationParams {
	o.SetOrganizationToCreate(organizationToCreate)
	return o
}

// SetOrganizationToCreate adds the organizationToCreate to the create organization params
func (o *CreateOrganizationParams) SetOrganizationToCreate(organizationToCreate *models.OrganizationCreationParamsDTO) {
	o.OrganizationToCreate = organizationToCreate
}
...
func (o *CreateOrganizationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.OrganizationToCreate != nil {
		if err := r.SetBodyParam(o.OrganizationToCreate); err != nil {
			return err
		}
	}
