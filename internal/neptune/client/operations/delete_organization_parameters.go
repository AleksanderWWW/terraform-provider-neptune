...
func (o *DeleteOrganizationParams) WithOrganizationID(organizationID strfmt.UUID) *DeleteOrganizationParams {
	o.SetOrganizationID(organizationID)
	return o
}

// SetOrganizationID adds the organizationId to the delete organization params
func (o *DeleteOrganizationParams) SetOrganizationID(organizationID strfmt.UUID) {
