...
type ChangePasswordParams struct {
	...
	// PasswordToUpdate.
	PasswordToUpdate *models.PasswordChangeDTO
...
// WithPasswordToUpdate adds the passwordToUpdate to the change password params
func (o *ChangePasswordParams) WithPasswordToUpdate(passwordToUpdate *models.PasswordChangeDTO) *ChangePasswordParams {
	o.SetPasswordToUpdate(passwordToUpdate)
	return o
}

// SetPasswordToUpdate adds the passwordToUpdate to the change password params
func (o *ChangePasswordParams) SetPasswordToUpdate(passwordToUpdate *models.PasswordChangeDTO) {
	o.PasswordToUpdate = passwordToUpdate
}
...
func (o *ChangePasswordParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.PasswordToUpdate != nil {
		if err := r.SetBodyParam(o.PasswordToUpdate); err != nil {
			return err
		}
	}
