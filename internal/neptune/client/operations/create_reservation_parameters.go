...
type CreateReservationParams struct {
	...
	// NewReservation.
	NewReservation *models.NewReservationDTO
...
// WithNewReservation adds the newReservation to the create reservation params
func (o *CreateReservationParams) WithNewReservation(newReservation *models.NewReservationDTO) *CreateReservationParams {
	o.SetNewReservation(newReservation)
	return o
}

// SetNewReservation adds the newReservation to the create reservation params
func (o *CreateReservationParams) SetNewReservation(newReservation *models.NewReservationDTO) {
	o.NewReservation = newReservation
}
...
func (o *CreateReservationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.NewReservation != nil {
		if err := r.SetBodyParam(o.NewReservation); err != nil {
			return err
		}
	}
