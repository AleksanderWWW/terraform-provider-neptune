...
// WithInvitationID adds the invitationID to the get organization invitation params
func (o *GetOrganizationInvitationParams) WithInvitationID(invitationID strfmt.UUID) *GetOrganizationInvitationParams {
	o.SetInvitationID(invitationID)
	return o
}

// SetInvitationID adds the invitationId to the get organization invitation params
func (o *GetOrganizationInvitationParams) SetInvitationID(invitationID strfmt.UUID) {
