...
type UpdateOrganizationParams struct {
	...
	OrganizationToUpdate *models.OrganizationUpdateDTO
...
func (o *UpdateOrganizationParams) WithOrganizationID(organizationID strfmt.UUID) *UpdateOrganizationParams {
	o.SetOrganizationID(organizationID)
	return o
}

// SetOrganizationID adds the organizationId to the update organization params
func (o *UpdateOrganizationParams) SetOrganizationID(organizationID strfmt.UUID) {
	o.OrganizationID = organizationID
}

// WithOrganizationToUpdate adds the organizationToUpdate to the update organization params
func (o *UpdateOrganizationParams) WithOrganizationToUpdate(organizationToUpdate *models.OrganizationUpdateDTO) *UpdateOrganizationParams {
	o.SetOrganizationToUpdate(organizationToUpdate)
	return o
}

// SetOrganizationToUpdate adds the organizationToUpdate to the update organization params
func (o *UpdateOrganizationParams) SetOrganizationToUpdate(organizationToUpdate *models.OrganizationUpdateDTO) {
	o.OrganizationToUpdate = organizationToUpdate
}
...
func (o *UpdateOrganizationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.OrganizationToUpdate != nil {
		if err := r.SetBodyParam(o.OrganizationToUpdate); err != nil {
			return err
		}
	}
