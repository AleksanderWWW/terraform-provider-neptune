...
// WithInvitationID adds the invitationID to the accept organization invitation params
func (o *AcceptOrganizationInvitationParams) WithInvitationID(invitationID strfmt.UUID) *AcceptOrganizationInvitationParams {
	o.SetInvitationID(invitationID)
	return o
}

// SetInvitationID adds the invitationId to the accept organization invitation params
func (o *AcceptOrganizationInvitationParams) SetInvitationID(invitationID strfmt.UUID) {
