...
// WithOrganizationIdentifier adds the organizationIdentifier to the delete organization member params
func (o *DeleteOrganizationMemberParams) WithOrganizationIdentifier(organizationIdentifier string) *DeleteOrganizationMemberParams {
	o.SetOrganizationIdentifier(organizationIdentifier)
	return o
}

// SetOrganizationIdentifier adds the organizationIdentifier to the delete organization member params
func (o *DeleteOrganizationMemberParams) SetOrganizationIdentifier(organizationIdentifier string) {
	o.OrganizationIdentifier = organizationIdentifier
}

// WithUserID adds the userID to the delete organization member params
func (o *DeleteOrganizationMemberParams) WithUserID(userID string) *DeleteOrganizationMemberParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the delete organization member params
func (o *DeleteOrganizationMemberParams) SetUserID(userID string) {
	o.UserID = userID
}
