...
// WithProjectToCreate adds the projectToCreate to the create project params
func (o *CreateProjectParams) WithProjectToCreate(projectToCreate *models.NewProjectDTO) *CreateProjectParams {
	o.SetProjectToCreate(projectToCreate)
	return o
}

// SetProjectToCreate adds the projectToCreate to the create project params
func (o *CreateProjectParams) SetProjectToCreate(projectToCreate *models.NewProjectDTO) {
	o.ProjectToCreate = projectToCreate
}
...
func (o *CreateProjectParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.ProjectToCreate != nil {
		if err := r.SetBodyParam(o.ProjectToCreate); err != nil {
			return err
		}
	}
