...
// ContextValidate validates this component status based on context it is used
func (m *ComponentStatus) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
